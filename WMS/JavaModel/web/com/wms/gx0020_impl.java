/*
       ...
       Generated on: January 5, 2018 11:41:24.43
...
public final  class gx0020_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20181511412454");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.wms.gx0020") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13pUVID_CONTROLCDDocEntry,9,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV14pLineId,9,0)))+"\">") ;
   ...
   {
      return formatLink("com.wms.gx0020") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13pUVID_CONTROLCDDocEntry,9,0))) + "," + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV14pLineId,9,0))) ;
   }
   ...
   public void wb0P0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblLbluvid_controlcddocentryfilter_Internalname, "UVID_CONTROLCDDoc Entry", "", "", lblLbluvid_controlcddocentryfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110p1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0020.htm");
         ...
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblLbllineidfilter_Internalname, "Line Id", "", "", lblLbllineidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120p1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0020.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblLblvisorderfilter_Internalname, "Vis Order", "", "", lblLblvisorderfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e130p1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0020.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblLbluvid_controlcdobjectfilter_Internalname, "UVID_CONTROLCDObject", "", "", lblLbluvid_controlcdobjectfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e140p1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0020.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.wms.GxWebStd.gx_single_line_edit( httpContext, edtavCuvid_controlcdobject_Internalname, AV9cUVID_CONTROLCDObject, GXutil.rtrim( localUtil.format( AV9cUVID_CONTROLCDObject, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCuvid_controlcdobject_Jsonclick, 0, "Attribute", "", "", "", edtavCuvid_controlcdobject_Visible, edtavCuvid_controlcdobject_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_Gx0020.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblLbluvid_controlcdloginstfilter_Internalname, "UVID_CONTROLCDLog Inst", "", "", lblLbluvid_controlcdloginstfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e150p1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0020.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblLblu_codatrfilter_Internalname, "U_Cod Atr", "", "", lblLblu_codatrfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e160p1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0020.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.wms.GxWebStd.gx_single_line_edit( httpContext, edtavCu_codatr_Internalname, AV11cU_CodAtr, GXutil.rtrim( localUtil.format( AV11cU_CodAtr, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCu_codatr_Jsonclick, 0, "Attribute", "", "", "", edtavCu_codatr_Visible, edtavCu_codatr_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_Gx0020.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblLblu_nameatrfilter_Internalname, "U_Name Atr", "", "", lblLblu_nameatrfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e170p1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0020.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.wms.GxWebStd.gx_single_line_edit( httpContext, edtavCu_nameatr_Internalname, AV12cU_NameAtr, GXutil.rtrim( localUtil.format( AV12cU_NameAtr, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,76);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCu_nameatr_Jsonclick, 0, "Attribute", "", "", "", edtavCu_nameatr_Visible, edtavCu_nameatr_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_Gx0020.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         StyleString = "" ;
         com.wms.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 84, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e180p1_client"+"'", TempTags, "", 2, "HLP_Gx0020.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      if ( wbEnd == 84 )
      {
         ...
         StyleString = "" ;
         com.wms.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 84, 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx0020.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void rf0P2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A110U_NameAtr = H000P2_A110U_NameAtr[0] ;
            n110U_NameAtr = H000P2_n110U_NameAtr[0] ;
            A112U_Critico = H000P2_A112U_Critico[0] ;
            n112U_Critico = H000P2_n112U_Critico[0] ;
            A111U_Cualitat = H000P2_A111U_Cualitat[0] ;
            n111U_Cualitat = H000P2_n111U_Cualitat[0] ;
            A109U_CodAtr = H000P2_A109U_CodAtr[0] ;
            n109U_CodAtr = H000P2_n109U_CodAtr[0] ;
            A108UVID_CONTROLCDLogInst = H000P2_A108UVID_CONTROLCDLogInst[0] ;
            n108UVID_CONTROLCDLogInst = H000P2_n108UVID_CONTROLCDLogInst[0] ;
            A107UVID_CONTROLCDObject = H000P2_A107UVID_CONTROLCDObject[0] ;
            n107UVID_CONTROLCDObject = H000P2_n107UVID_CONTROLCDObject[0] ;
            A106VisOrder = H000P2_A106VisOrder[0] ;
            n106VisOrder = H000P2_n106VisOrder[0] ;
            A42LineId = H000P2_A42LineId[0] ;
            A41UVID_CONTROLCDDocEntry = H000P2_A41UVID_CONTROLCDDocEntry[0] ;
            /* Execute user event: Load */
            e200P2 ();
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20181511412618");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx0020.js", "?20181511412620");
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("'TOGGLE'","{handler:'e180P1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}],oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
      setEventMetadata("LBLUVID_CONTROLCDDOCENTRYFILTER.CLICK","{handler:'e110P1',iparms:[{av:'divUvid_controlcddocentryfiltercontainer_Class',ctrl:'UVID_CONTROLCDDOCENTRYFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divUvid_controlcddocentryfiltercontainer_Class',ctrl:'UVID_CONTROLCDDOCENTRYFILTERCONTAINER',prop:'Class'},{av:'edtavCuvid_controlcddocentry_Visible',ctrl:'vCUVID_CONTROLCDDOCENTRY',prop:'Visible'}]}");
      setEventMetadata("LBLLINEIDFILTER.CLICK","{handler:'e120P1',iparms:[{av:'divLineidfiltercontainer_Class',ctrl:'LINEIDFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divLineidfiltercontainer_Class',ctrl:'LINEIDFILTERCONTAINER',prop:'Class'},{av:'edtavClineid_Visible',ctrl:'vCLINEID',prop:'Visible'}]}");
      setEventMetadata("LBLVISORDERFILTER.CLICK","{handler:'e130P1',iparms:[{av:'divVisorderfiltercontainer_Class',ctrl:'VISORDERFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divVisorderfiltercontainer_Class',ctrl:'VISORDERFILTERCONTAINER',prop:'Class'},{av:'edtavCvisorder_Visible',ctrl:'vCVISORDER',prop:'Visible'}]}");
      setEventMetadata("LBLUVID_CONTROLCDOBJECTFILTER.CLICK","{handler:'e140P1',iparms:[{av:'divUvid_controlcdobjectfiltercontainer_Class',ctrl:'UVID_CONTROLCDOBJECTFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divUvid_controlcdobjectfiltercontainer_Class',ctrl:'UVID_CONTROLCDOBJECTFILTERCONTAINER',prop:'Class'},{av:'edtavCuvid_controlcdobject_Visible',ctrl:'vCUVID_CONTROLCDOBJECT',prop:'Visible'}]}");
      setEventMetadata("LBLUVID_CONTROLCDLOGINSTFILTER.CLICK","{handler:'e150P1',iparms:[{av:'divUvid_controlcdloginstfiltercontainer_Class',ctrl:'UVID_CONTROLCDLOGINSTFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divUvid_controlcdloginstfiltercontainer_Class',ctrl:'UVID_CONTROLCDLOGINSTFILTERCONTAINER',prop:'Class'},{av:'edtavCuvid_controlcdloginst_Visible',ctrl:'vCUVID_CONTROLCDLOGINST',prop:'Visible'}]}");
      setEventMetadata("LBLU_CODATRFILTER.CLICK","{handler:'e160P1',iparms:[{av:'divU_codatrfiltercontainer_Class',ctrl:'U_CODATRFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divU_codatrfiltercontainer_Class',ctrl:'U_CODATRFILTERCONTAINER',prop:'Class'},{av:'edtavCu_codatr_Visible',ctrl:'vCU_CODATR',prop:'Visible'}]}");
      setEventMetadata("LBLU_NAMEATRFILTER.CLICK","{handler:'e170P1',iparms:[{av:'divU_nameatrfiltercontainer_Class',ctrl:'U_NAMEATRFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divU_nameatrfiltercontainer_Class',ctrl:'U_NAMEATRFILTERCONTAINER',prop:'Class'},{av:'edtavCu_nameatr_Visible',ctrl:'vCU_NAMEATR',prop:'Visible'}]}");
      setEventMetadata("ENTER","{handler:'e210P2',iparms:[{av:'A41UVID_CONTROLCDDocEntry',fld:'UVID_CONTROLCDDOCENTRY',pic:'ZZZZZZZZ9',hsh:true,nv:0},{av:'A42LineId',fld:'LINEID',pic:'ZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'AV13pUVID_CONTROLCDDocEntry',fld:'vPUVID_CONTROLCDDOCENTRY',pic:'ZZZZZZZZ9',nv:0},{av:'AV14pLineId',fld:'vPLINEID',pic:'ZZZZZZZZ9',nv:0}]}");
   ...
   public void initialize( )
   {
      ...
      lV12cU_NameAtr = "" ;
      A110U_NameAtr = "" ;
      H000P2_A110U_NameAtr = new String[] {""} ;
      H000P2_n110U_NameAtr = new boolean[] {false} ;
      H000P2_A112U_Critico = new String[] {""} ;
      H000P2_n112U_Critico = new boolean[] {false} ;
      H000P2_A111U_Cualitat = new String[] {""} ;
      H000P2_n111U_Cualitat = new boolean[] {false} ;
      H000P2_A109U_CodAtr = new String[] {""} ;
      H000P2_n109U_CodAtr = new boolean[] {false} ;
      H000P2_A108UVID_CONTROLCDLogInst = new int[1] ;
      H000P2_n108UVID_CONTROLCDLogInst = new boolean[] {false} ;
      H000P2_A107UVID_CONTROLCDObject = new String[] {""} ;
      H000P2_n107UVID_CONTROLCDObject = new boolean[] {false} ;
      H000P2_A106VisOrder = new int[1] ;
      H000P2_n106VisOrder = new boolean[] {false} ;
      H000P2_A42LineId = new int[1] ;
      H000P2_A41UVID_CONTROLCDDocEntry = new int[1] ;
      H000P3_AGRID1_nRecordCount = new long[1] ;
      AV15ADVANCED_LABEL_TEMPLATE = "" ;
      Grid1Row = new com.genexus.webpanels.GXWebRow();
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_default = new DataStoreProvider(context, remoteHandle, new com.wms.gx0020__default(),
         new Object[] {
             new Object[] {
            H000P2_A110U_NameAtr, H000P2_n110U_NameAtr, H000P2_A112U_Critico, H000P2_n112U_Critico, H000P2_A111U_Cualitat, H000P2_n111U_Cualitat, H000P2_A109U_CodAtr, H000P2_n109U_CodAtr, H000P2_A108UVID_CONTROLCDLogInst, H000P2_n108UVID_CONTROLCDLogInst,
            H000P2_A107UVID_CONTROLCDObject, H000P2_n107UVID_CONTROLCDObject, H000P2_A106VisOrder, H000P2_n106VisOrder, H000P2_A42LineId, H000P2_A41UVID_CONTROLCDDocEntry
            }
            , new Object[] {
   ...
   private String[] H000P2_A110U_NameAtr ;
   private boolean[] H000P2_n110U_NameAtr ;
   private String[] H000P2_A112U_Critico ;
   private boolean[] H000P2_n112U_Critico ;
   private String[] H000P2_A111U_Cualitat ;
   private boolean[] H000P2_n111U_Cualitat ;
   private String[] H000P2_A109U_CodAtr ;
   private boolean[] H000P2_n109U_CodAtr ;
   private int[] H000P2_A108UVID_CONTROLCDLogInst ;
   private boolean[] H000P2_n108UVID_CONTROLCDLogInst ;
   private String[] H000P2_A107UVID_CONTROLCDObject ;
   private boolean[] H000P2_n107UVID_CONTROLCDObject ;
   private int[] H000P2_A106VisOrder ;
   private boolean[] H000P2_n106VisOrder ;
   private int[] H000P2_A42LineId ;
   private int[] H000P2_A41UVID_CONTROLCDDocEntry ;
