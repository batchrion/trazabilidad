/*
       ...
       Generated on: January 12, 2018 10:22:39.57
...
public final  class recentlinks_impl extends GXWebComponent
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201811210223964");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("com.wms.recentlinks") + "?" + GXutil.URLEncode(GXutil.rtrim(AV6FormCaption)) + "," + GXutil.URLEncode(GXutil.rtrim(AV7FormPgmName))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      /* Send saved values. */
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"nRC_GXsfl_7", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_7, (byte)(4), (byte)(0), ",", "")));
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV6FormCaption", GXutil.rtrim( wcpOAV6FormCaption));
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV7FormPgmName", wcpOAV7FormPgmName);
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vFORMCAPTION", GXutil.rtrim( AV6FormCaption));
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vFORMPGMNAME", AV7FormPgmName);
      GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
   }
   ...
   public void renderHtmlCloseForm022( )
   {
      ...
      {
         httpContext.AddJavascriptSource("recentlinks.js", "?201811210223966");
      }
   ...
   public void wb020( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.wms.recentlinks");
         }
   ...
   private void e12022( )
   {
      ...
      {
         AV12RecentLinksItem = (com.wms.SdtLinkList_LinkItem)((com.wms.SdtLinkList_LinkItem)AV11RecentLinksItems.elementAt(-1+AV9i));
      ...
      AV12RecentLinksItem = (com.wms.SdtLinkList_LinkItem)new com.wms.SdtLinkList_LinkItem(remoteHandle, context);
   ...
   public void wb_table2_14_022( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.wms.GxWebStd.gx_table_start( httpContext, tblBottomline_Internalname, tblBottomline_Internalname, "", "TableHorizontalLine", 0, "", "", 0, 0, sStyleString, "none", 0);
   ...
   public void wb_table1_2_022( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.wms.GxWebStd.gx_table_start( httpContext, tblTable_Internalname, tblTable_Internalname, "", "RecentLinksTable", 0, "", "", 0, 0, sStyleString, "none", 0);
         httpContext.writeText( "<tbody>") ;
         httpContext.writeText( "<tr>") ;
         httpContext.writeText( "<td style=\""+GXutil.CssPrettify( "width:1%")+"\">") ;
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblRecenttext_Internalname, "Recents: ", "", "", lblRecenttext_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "RecentLink", 0, "", 1, 1, (short)(0), "HLP_RecentLinks.htm");
         httpContext.writeText( "</td>") ;
         httpContext.writeText( "<td>") ;
         /*  Grid Control  */
         ...
         if ( LinksContainer.GetWrapped() == 1 )
         {
            ...
            sStyleString = "" ;
            com.wms.GxWebStd.gx_table_start( httpContext, subLinks_Internalname, subLinks_Internalname, "", "RecentLinksTable", 0, "", "", 1, 2, sStyleString, "none", 0);
            LinksContainer.AddObjectProperty("GridName", "Links");
         }
         else
         {
      ...
      if ( wbEnd == 7 )
      {
         ...
         else
         {
            ...
            {
               com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"LinksContainerData", LinksContainer.ToJavascriptSource());
            }
            if ( httpContext.isAjaxRequest( ) || httpContext.isSpaRequest( ) )
            {
               com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"LinksContainerData"+"V", LinksContainer.GridValuesHidden());
            }
            else
            {
   ...
   {
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6FormCaption_PARM", GXutil.rtrim( AV6FormCaption));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV6FormCaption)) > 0 )
      {
         com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV6FormCaption_CTRL", GXutil.rtrim( sCtrlAV6FormCaption));
      }
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7FormPgmName_PARM", AV7FormPgmName);
      if ( GXutil.len( GXutil.rtrim( sCtrlAV7FormPgmName)) > 0 )
      {
         com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV7FormPgmName_CTRL", GXutil.rtrim( sCtrlAV7FormPgmName));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201811210223997");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("recentlinks.js", "?201811210223997");
      }
   ...
   public void initialize( )
   {
      ...
      AV11RecentLinksItems = new GXBaseCollection<com.wms.SdtLinkList_LinkItem>(com.wms.SdtLinkList_LinkItem.class, "LinkList.LinkItem", "GeneXus", remoteHandle);
      AV8Session = httpContext.getWebSession();
      AV12RecentLinksItem = new com.wms.SdtLinkList_LinkItem(remoteHandle, context);
   ...
   private GXBaseCollection<com.wms.SdtLinkList_LinkItem> AV11RecentLinksItems ;
   private com.wms.SdtLinkList_LinkItem AV12RecentLinksItem ;
}
