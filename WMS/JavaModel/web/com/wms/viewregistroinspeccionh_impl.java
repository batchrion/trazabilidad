/*
               File: viewregistroinspeccionh_impl
        Description: View Registro Inspeccion H
             Author: GeneXus Java Generator version 15_0_3-111985
       Generated on: January 5, 2018 15:0:53.42
...
public final  class viewregistroinspeccionh_impl extends GXDataArea
{
   public viewregistroinspeccionh_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public viewregistroinspeccionh_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( viewregistroinspeccionh_impl.class ));
   }
   ...
   public void initweb( )
   {
      ...
      if ( nGotPars == 0 )
      {
         ...
         {
            AV12UVID_CONTROLCHDocEntry = (int)(GXutil.lval( gxfirstwebparm)) ;
            httpContext.ajax_rsp_assign_attri("", false, "AV12UVID_CONTROLCHDocEntry", GXutil.ltrim( GXutil.str( AV12UVID_CONTROLCHDocEntry, 9, 0)));
            httpContext.ajax_rsp_assign_attri("", false, "gxhash_vUVID_CONTROLCHDOCENTRY", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12UVID_CONTROLCHDocEntry), "ZZZZZZZZ9")));
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?2018151505347");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.wms.viewregistroinspeccionh") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV12UVID_CONTROLCHDocEntry,9,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV6TabCode))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.wms.GxWebStd.gx_hidden_field( httpContext, "vUVID_CONTROLCHDOCENTRY", GXutil.ltrim( localUtil.ntoc( AV12UVID_CONTROLCHDocEntry, (byte)(9), (byte)(0), ",", "")));
      ...
      com.wms.GxWebStd.gx_hidden_field( httpContext, "gxhash_vUVID_CONTROLCHDOCENTRY", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12UVID_CONTROLCHDocEntry), "ZZZZZZZZ9")));
      ...
      forbiddenHiddens = "hsh" + "ViewRegistroInspeccionH" ;
      forbiddenHiddens = forbiddenHiddens + GXutil.rtrim( localUtil.format( A65U_WhsCode, "")) ;
   ...
   {
      return formatLink("com.wms.viewregistroinspeccionh") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV12UVID_CONTROLCHDocEntry,9,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV6TabCode)) ;
   }

   public String getPgmname( )
   {
      return "ViewRegistroInspeccionH" ;
   }
   ...
   public void wb0T0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, "Registro Inspeccion H Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_ViewRegistroInspeccionH.htm");
         ...
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblViewall_Internalname, "Registro Inspeccion Hs", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, (short)(0), "HLP_ViewRegistroInspeccionH.htm");
         ...
         /* Single line edit */
         com.wms.GxWebStd.gx_single_line_edit( httpContext, edtU_WhsCode_Internalname, A65U_WhsCode, GXutil.rtrim( localUtil.format( A65U_WhsCode, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtU_WhsCode_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtU_WhsCode_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_ViewRegistroInspeccionH.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewRegistroInspeccionH.htm");
         /* Div Control */
   ...
   public void start0T2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "View Registro Inspeccion H", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV15Pgmname = "ViewRegistroInspeccionH" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf0T2( )
   {
      ...
      {
         /* Using cursor H000T2 */
         pr_default.execute(0, new Object[] {new Integer(AV12UVID_CONTROLCHDocEntry)});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A43UVID_CONTROLCHDocEntry = H000T2_A43UVID_CONTROLCHDocEntry[0] ;
            A65U_WhsCode = H000T2_A65U_WhsCode[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A65U_WhsCode", A65U_WhsCode);
            httpContext.ajax_rsp_assign_attri("", false, "gxhash_U_WHSCODE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A65U_WhsCode, ""))));
            n65U_WhsCode = H000T2_n65U_WhsCode[0] ;
            /* Execute user event: Load */
            e120T2 ();
   ...
   public void strup0T0( )
   {
      ...
      if ( GXutil.strcmp(httpContext.getRequestMethod( ), "POST") == 0 )
      {
         ...
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_U_WHSCODE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A65U_WhsCode, ""))));
         /* Read saved values. */
         AV12UVID_CONTROLCHDocEntry = (int)(localUtil.ctol( httpContext.cgiGet( "vUVID_CONTROLCHDOCENTRY"), ",", ".")) ;
   ...
   public void e110T2( )
   {
      ...
      AV16GXLvl6 = (byte)(0) ;
      /* Using cursor H000T3 */
      pr_default.execute(1, new Object[] {new Integer(AV12UVID_CONTROLCHDocEntry)});
      while ( (pr_default.getStatus(1) != 101) )
      {
         A43UVID_CONTROLCHDocEntry = H000T3_A43UVID_CONTROLCHDocEntry[0] ;
         A65U_WhsCode = H000T3_A65U_WhsCode[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A65U_WhsCode", A65U_WhsCode);
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_U_WHSCODE", getSecureSignedToken( "", GXutil.rtrim( localUtil.format( A65U_WhsCode, ""))));
         n65U_WhsCode = H000T3_n65U_WhsCode[0] ;
         AV16GXLvl6 = (byte)(1) ;
         Form.setCaption( A65U_WhsCode );
         httpContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.getCaption(), true);
         lblViewall_Link = formatLink("com.wms.wwregistroinspeccionh")  ;
   ...
   public void S112( )
   {
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "RegistroInspeccionHGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.wms.registroinspeccionhgeneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "RegistroInspeccionHGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
            WebComp_Generalwc.setjustcreated();
            WebComp_Generalwc.componentprepare(new Object[] {"W0029","",new Integer(AV12UVID_CONTROLCHDocEntry)});
   ...
   {
      AV12UVID_CONTROLCHDocEntry = ((Number) GXutil.testNumericType( getParm(obj,0), TypeConstants.INT)).intValue() ;
      httpContext.ajax_rsp_assign_attri("", false, "AV12UVID_CONTROLCHDocEntry", GXutil.ltrim( GXutil.str( AV12UVID_CONTROLCHDocEntry, 9, 0)));
      httpContext.ajax_rsp_assign_attri("", false, "gxhash_vUVID_CONTROLCHDOCENTRY", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(AV12UVID_CONTROLCHDocEntry), "ZZZZZZZZ9")));
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?2018151505394");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("viewregistroinspeccionh.js", "?2018151505394");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "");
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "View Registro Inspeccion H" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      AV15Pgmname = "" ;
      scmdbuf = "" ;
      H000T2_A43UVID_CONTROLCHDocEntry = new int[1] ;
      H000T2_A65U_WhsCode = new String[] {""} ;
      H000T2_n65U_WhsCode = new boolean[] {false} ;
      hsh = "" ;
      H000T3_A43UVID_CONTROLCHDocEntry = new int[1] ;
      H000T3_A65U_WhsCode = new String[] {""} ;
      H000T3_n65U_WhsCode = new boolean[] {false} ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.wms.viewregistroinspeccionh__default(),
         new Object[] {
             new Object[] {
            H000T2_A43UVID_CONTROLCHDocEntry, H000T2_A65U_WhsCode, H000T2_n65U_WhsCode
            }
            , new Object[] {
            H000T3_A43UVID_CONTROLCHDocEntry, H000T3_A65U_WhsCode, H000T3_n65U_WhsCode
            }
         }
      );
      AV15Pgmname = "ViewRegistroInspeccionH" ;
   ...
   private int wcpOAV12UVID_CONTROLCHDocEntry ;
   private int AV12UVID_CONTROLCHDocEntry ;
   ...
   private int[] H000T2_A43UVID_CONTROLCHDocEntry ;
   private String[] H000T2_A65U_WhsCode ;
   private boolean[] H000T2_n65U_WhsCode ;
   private int[] H000T3_A43UVID_CONTROLCHDocEntry ;
   private String[] H000T3_A65U_WhsCode ;
   private boolean[] H000T3_n65U_WhsCode ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class viewregistroinspeccionh__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000T2", "SELECT [DocEntry], [U_WhsCode] FROM dbo.[@VID_CONTROLCH] WITH (NOLOCK) WHERE [DocEntry] = ? ORDER BY [DocEntry] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H000T3", "SELECT [DocEntry], [U_WhsCode] FROM dbo.[@VID_CONTROLCH] WITH (NOLOCK) WHERE [DocEntry] = ? ORDER BY [DocEntry] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
