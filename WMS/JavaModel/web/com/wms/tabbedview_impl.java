/*
       ...
       Generated on: January 12, 2018 10:22:41.47
...
public final  class tabbedview_impl extends GXWebComponent
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201811210224153");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("com.wms.tabbedview") + "?" + GXutil.URLEncode(GXutil.rtrim(AV15TabCode))+"\">") ;
      ...
      else
      {
         ...
         com.wms.GxWebStd.classAttribute( httpContext, "gxwebcomponent-body"+" "+((GXutil.strcmp("", Form.getThemeClass())==0) ? "Form" : Form.getThemeClass())+"-fx");
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      /* Send saved values. */
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"wcpOAV15TabCode", GXutil.rtrim( wcpOAV15TabCode));
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vFIRSTTAB", GXutil.ltrim( localUtil.ntoc( AV5FirstTab, (byte)(4), (byte)(0), ",", "")));
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vLASTTAB", GXutil.ltrim( localUtil.ntoc( AV11LastTab, (byte)(4), (byte)(0), ",", "")));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTABCODE", GXutil.rtrim( AV15TabCode));
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vINDEX", GXutil.ltrim( localUtil.ntoc( AV8Index, (byte)(4), (byte)(0), ",", "")));
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vSELECTEDTAB", GXutil.ltrim( localUtil.ntoc( AV13SelectedTab, (byte)(4), (byte)(0), ",", "")));
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTABSMARKUP", GXutil.rtrim( AV19TabsMarkup));
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"vTABTEMPLATE", GXutil.rtrim( AV20TabTemplate));
      if ( httpContext.isAjaxRequest( ) )
      {
      ...
      com.wms.GxWebStd.gx_boolean_hidden_field( httpContext, sPrefix+"vURLCHANGEDEVENT", AV23URLChangedEvent);
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"HISTORYMANAGER_Hash", GXutil.rtrim( Historymanager_Hash));
   ...
   public void renderHtmlCloseForm092( )
   {
      ...
      {
         httpContext.AddJavascriptSource("tabbedview.js", "?201811210224158");
      }
   ...
   public void wb090( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.wms.tabbedview");
            httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "");
            httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "");
            httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "");
            httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "");
               ...
               if ( GXutil.len( sEvt) > 0 )
               {
                  ...
                  else if ( GXutil.strcmp(sEvtType, "W") == 0 )
                  {
                     ...
                     if ( nCmpId == 14 )
                     {
                        ...
                        {
                           WebComp_Component = WebUtils.getWebComponent(getClass(), "com.wms." + OldComponent + "_impl", remoteHandle, context);
   ...
   public void S122( )
   {
      ...
      {
         AV14Tab = (com.wms.SdtTabOptions_TabOptionsItem)((com.wms.SdtTabOptions_TabOptionsItem)AV18Tabs.elementAt(-1+AV8Index));
   ...
   public void S132( )
   {
      ...
      {
         if ( ( ( GXutil.strcmp(Historymanager_Hash, "") == 0 ) && ( ( GXutil.strcmp(((com.wms.SdtTabOptions_TabOptionsItem)AV18Tabs.elementAt(-1+AV8Index)).getgxTv_SdtTabOptions_TabOptionsItem_Code(), AV15TabCode) == 0 ) ) ) || ( ( GXutil.strcmp(((com.wms.SdtTabOptions_TabOptionsItem)AV18Tabs.elementAt(-1+AV8Index)).getgxTv_SdtTabOptions_TabOptionsItem_Code(), Historymanager_Hash) == 0 ) ) )
         {
   ...
   public void wb_table1_2_092( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.wms.GxWebStd.gx_table_start( httpContext, tblTable1_Internalname, tblTable1_Internalname, "", "ViewTable", 0, "", "", 0, 0, sStyleString, "none", 0);
         ...
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, divTabcontainer_Internalname, 1, 0, "px", 0, "px", "TabContainer", "left", "top", "", "", "div");
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblTabs_Internalname, lblTabs_Caption, "", "", lblTabs_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", 0, "", 1, 1, (short)(1), "HLP_TabbedView.htm");
         /* Static images/pictures */
         ClassString = "TabPagingPrevious" ;
         StyleString = "" ;
         sImgUrl = "(none)" ;
         com.wms.GxWebStd.gx_bitmap( httpContext, imgTabprevious_Internalname, sImgUrl, "", "", "", context.getHttpContext().getTheme( ), imgTabprevious_Visible, 1, "", "Previous Tab", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", 1, false, false, context.getHttpContext().getImageSrcSet( sImgUrl), "HLP_TabbedView.htm");
         /* Static images/pictures */
         ClassString = "TabPagingNext" ;
         StyleString = "" ;
         sImgUrl = "(none)" ;
         com.wms.GxWebStd.gx_bitmap( httpContext, imgTabnext_Internalname, sImgUrl, "", "", "", context.getHttpContext().getTheme( ), imgTabnext_Visible, 1, "", "Next Tab", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", 1, false, false, context.getHttpContext().getImageSrcSet( sImgUrl), "HLP_TabbedView.htm");
   ...
   public void wb_table2_11_092( boolean wbgen )
   {
      if ( wbgen )
      {
         /* Table start */
         sStyleString = "" ;
         com.wms.GxWebStd.gx_table_start( httpContext, tblTable2_Internalname, tblTable2_Internalname, "", "TableBorder", 0, "", "", 0, 0, sStyleString, "none", 0);
         httpContext.writeText( "<tbody>") ;
         httpContext.writeText( "<tr>") ;
         ...
         {
            /* WebComponent */
            com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"W0014"+"", GXutil.rtrim( WebComp_Component_Component));
            httpContext.writeText( "<div") ;
   ...
   {
      AV18Tabs = (GXBaseCollection<com.wms.SdtTabOptions_TabOptionsItem>)getParm(obj,0) ;
   ...
   public void componentprepare( Object[] obj )
   {
      ...
      {
         AV18Tabs = (GXBaseCollection<com.wms.SdtTabOptions_TabOptionsItem>)getParm(obj,2) ;
   ...
   public void wcparametersset( )
   {
      ...
      {
         com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV18Tabs_CTRL", GXutil.rtrim( sCtrlAV18Tabs));
      }
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV15TabCode_PARM", GXutil.rtrim( AV15TabCode));
      if ( GXutil.len( GXutil.rtrim( sCtrlAV15TabCode)) > 0 )
      {
         com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"AV15TabCode_CTRL", GXutil.rtrim( sCtrlAV15TabCode));
      }
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201811210224195");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   {
      httpContext.AddJavascriptSource("tabbedview.js", "?201811210224195");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "");
   ...
   public void initialize( )
   {
      ...
      gxfirstwebparm_bkp = "" ;
      sPrefix = "" ;
      AV18Tabs = new GXBaseCollection<com.wms.SdtTabOptions_TabOptionsItem>(com.wms.SdtTabOptions_TabOptionsItem.class, "TabOptions.TabOptionsItem", "WMS", remoteHandle);
      AV15TabCode = "" ;
      ...
      AV19TabsMarkup = "" ;
      AV20TabTemplate = "" ;
      AV14Tab = new com.wms.SdtTabOptions_TabOptionsItem(remoteHandle, context);
      GXKey = "" ;
      GX_FocusControl = "" ;
      sXEvt = "" ;
      sEvt = "" ;
   ...
   private GXBaseCollection<com.wms.SdtTabOptions_TabOptionsItem> AV18Tabs ;
   private com.wms.SdtTabOptions_TabOptionsItem AV14Tab ;
}
