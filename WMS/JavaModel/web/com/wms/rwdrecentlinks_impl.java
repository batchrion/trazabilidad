/*
       ...
       Generated on: January 12, 2018 10:22:40.40
...
public final  class rwdrecentlinks_impl extends GXWebComponent
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201811210224045");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      if ( GXutil.len( sPrefix) == 0 )
      {
         ...
         httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.wms.rwdrecentlinks") + "?" + GXutil.URLEncode(GXutil.rtrim(AV6FormCaption)) + "," + GXutil.URLEncode(GXutil.rtrim(AV7FormPgmName))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      /* Send saved values. */
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"nRC_GXsfl_8", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_8, (byte)(4), (byte)(0), ",", "")));
      ...
      com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"MAINTABLE_Class", GXutil.rtrim( divMaintable_Class));
      GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
   }
   ...
   public void renderHtmlCloseForm052( )
   {
      ...
      {
         httpContext.AddJavascriptSource("rwdrecentlinks.js", "?201811210224049");
      }
   ...
   public void wb050( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         if ( GXutil.len( sPrefix) != 0 )
         {
            com.wms.GxWebStd.gx_hidden_field( httpContext, sPrefix+"_CMPPGM", "com.wms.rwdrecentlinks");
         }
         ...
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, divMaintable_Internalname, 1, 0, "px", 0, "px", divMaintable_Class, "left", "top", "", "", "div");
         /* Div Control */
         ...
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblRecenttext_Internalname, "Recents", "", "", lblRecenttext_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e11051_client"+"'", "", "RecentsTitle", 7, "", 1, 1, (short)(0), "HLP_RwdRecentLinks.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-10 col-md-11", "left", "top", "", "", "div");
         /*  Grid Control  */
         ...
         if ( LinksContainer.GetWrapped() == 1 )
         {
            ...
            sStyleString = "" ;
            com.wms.GxWebStd.gx_table_start( httpContext, subLinks_Internalname, subLinks_Internalname, "", "RecentLinksGrid", 0, "", "", 1, 2, sStyleString, "", 0);
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201811210224079");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   {
      httpContext.AddJavascriptSource("rwdrecentlinks.js", "?201811210224080");
