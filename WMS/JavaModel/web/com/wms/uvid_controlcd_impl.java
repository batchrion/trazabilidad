/*
               File: uvid_controlcd_impl
        Description: UVID_CONTROLCD
             Author: GeneXus Java Generator version 15_0_3-111985
       Generated on: January 12, 2018 10:22:50.48
...
public final  class uvid_controlcd_impl extends GXDataArea
{
   public void initenv( )
   {
      if ( GxWebError != 0 )
   ...
   public void inittrn( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "UVID_CONTROLCD", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   public uvid_controlcd_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public uvid_controlcd_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( uvid_controlcd_impl.class ));
   }
   ...
   public void draw( )
   {
      ...
      if ( ! com.wms.GxWebStd.gx_redirect( httpContext) )
      {
         ...
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblTitle_Internalname, "UVID_CONTROLCD", "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Title", 0, "", 1, 1, (short)(0), "HLP_UVID_CONTROLCD.htm");
         ...
         StyleString = "" ;
         com.wms.GxWebStd.gx_button_ctrl( httpContext, bttBtn_first_Internalname, "", "", bttBtn_first_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_first_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"EFIRST."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_UVID_CONTROLCD.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.wms.GxWebStd.gx_button_ctrl( httpContext, bttBtn_previous_Internalname, "", "", bttBtn_previous_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_previous_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"EPREVIOUS."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_UVID_CONTROLCD.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         ClassString = "BtnNext" ;
         StyleString = "" ;
         com.wms.GxWebStd.gx_button_ctrl( httpContext, bttBtn_next_Internalname, "", "", bttBtn_next_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_next_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ENEXT."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_UVID_CONTROLCD.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         ClassString = "BtnLast" ;
         StyleString = "" ;
         com.wms.GxWebStd.gx_button_ctrl( httpContext, bttBtn_last_Internalname, "", "", bttBtn_last_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_last_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ELAST."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_UVID_CONTROLCD.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         com.wms.GxWebStd.gx_single_line_edit( httpContext, edtVisOrder_Internalname, GXutil.ltrim( localUtil.ntoc( A106VisOrder, (byte)(9), (byte)(0), ",", "")), ((edtVisOrder_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A106VisOrder), "ZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A106VisOrder), "ZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,41);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVisOrder_Jsonclick, 0, "Attribute", "", "", "", 1, edtVisOrder_Enabled, 0, "text", "", 9, "chr", 1, "row", 9, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_UVID_CONTROLCD.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.wms.GxWebStd.gx_single_line_edit( httpContext, edtU_NameAtr_Internalname, A110U_NameAtr, GXutil.rtrim( localUtil.format( A110U_NameAtr, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,57);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtU_NameAtr_Jsonclick, 0, "Attribute", "", "", "", 1, edtU_NameAtr_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_UVID_CONTROLCD.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.wms.GxWebStd.gx_single_line_edit( httpContext, edtU_Cualitat_Internalname, GXutil.rtrim( A111U_Cualitat), GXutil.rtrim( localUtil.format( A111U_Cualitat, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,61);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtU_Cualitat_Jsonclick, 0, "Attribute", "", "", "", 1, edtU_Cualitat_Enabled, 0, "text", "", 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_UVID_CONTROLCD.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.wms.GxWebStd.gx_single_line_edit( httpContext, edtU_Rango_Internalname, A114U_Rango, GXutil.rtrim( localUtil.format( A114U_Rango, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,73);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtU_Rango_Jsonclick, 0, "Attribute", "", "", "", 1, edtU_Rango_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_UVID_CONTROLCD.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.wms.GxWebStd.gx_single_line_edit( httpContext, edtU_TipoDef_Internalname, GXutil.rtrim( A115U_TipoDef), GXutil.rtrim( localUtil.format( A115U_TipoDef, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,77);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtU_TipoDef_Jsonclick, 0, "Attribute", "", "", "", 1, edtU_TipoDef_Enabled, 0, "text", "", 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_UVID_CONTROLCD.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.wms.GxWebStd.gx_single_line_edit( httpContext, edtU_Maximo_Internalname, GXutil.ltrim( localUtil.ntoc( A120U_Maximo, (byte)(18), (byte)(0), ",", "")), ((edtU_Maximo_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A120U_Maximo), "ZZZZZZZZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A120U_Maximo), "ZZZZZZZZZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,97);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtU_Maximo_Jsonclick, 0, "Attribute", "", "", "", 1, edtU_Maximo_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_UVID_CONTROLCD.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         com.wms.GxWebStd.gx_single_line_edit( httpContext, edtU_Medicion_Internalname, GXutil.ltrim( localUtil.ntoc( A121U_Medicion, (byte)(18), (byte)(0), ",", "")), ((edtU_Medicion_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(A121U_Medicion), "ZZZZZZZZZZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(A121U_Medicion), "ZZZZZZZZZZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,101);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtU_Medicion_Jsonclick, 0, "Attribute", "", "", "", 1, edtU_Medicion_Enabled, 0, "text", "", 18, "chr", 1, "row", 18, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_UVID_CONTROLCD.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         ClassString = "Attribute" ;
         StyleString = "" ;
         com.wms.GxWebStd.gx_html_textarea( httpContext, edtU_Comment2_Internalname, A124U_Comment2, "", TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,113);\"", (short)(0), 1, edtU_Comment2_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "254", -1, 0, "", "", (byte)(-1), true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_UVID_CONTROLCD.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         ...
         StyleString = "" ;
         com.wms.GxWebStd.gx_button_ctrl( httpContext, bttBtn_enter_Internalname, "", "Confirmar", bttBtn_enter_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, bttBtn_enter_Visible, bttBtn_enter_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_UVID_CONTROLCD.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.wms.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, bttBtn_cancel_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_UVID_CONTROLCD.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.wms.GxWebStd.gx_button_ctrl( httpContext, bttBtn_delete_Internalname, "", "Eliminar", bttBtn_delete_Jsonclick, 5, "Eliminar", "", StyleString, ClassString, bttBtn_delete_Visible, bttBtn_delete_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EDELETE."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_UVID_CONTROLCD.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void zm038( int GX_JID )
   {
      if ( ( GX_JID == 1 ) || ( GX_JID == 0 ) )
      {
         if ( GXutil.strcmp(Gx_mode, "INS") != 0 )
         {
            Z106VisOrder = T00033_A106VisOrder[0] ;
            Z107UVID_CONTROLCDObject = T00033_A107UVID_CONTROLCDObject[0] ;
            Z108UVID_CONTROLCDLogInst = T00033_A108UVID_CONTROLCDLogInst[0] ;
            Z109U_CodAtr = T00033_A109U_CodAtr[0] ;
            Z110U_NameAtr = T00033_A110U_NameAtr[0] ;
            Z111U_Cualitat = T00033_A111U_Cualitat[0] ;
            Z112U_Critico = T00033_A112U_Critico[0] ;
            Z113U_TipoMues = T00033_A113U_TipoMues[0] ;
            Z114U_Rango = T00033_A114U_Rango[0] ;
            Z115U_TipoDef = T00033_A115U_TipoDef[0] ;
            Z116U_AQL = T00033_A116U_AQL[0] ;
            Z117U_TiempoDu = T00033_A117U_TiempoDu[0] ;
            Z118U_StandAtr = T00033_A118U_StandAtr[0] ;
            Z119U_Minimo = T00033_A119U_Minimo[0] ;
            Z120U_Maximo = T00033_A120U_Maximo[0] ;
            Z121U_Medicion = T00033_A121U_Medicion[0] ;
            Z122U_CodEquip = T00033_A122U_CodEquip[0] ;
            Z123UVID_CONTROLCDU_Comment = T00033_A123UVID_CONTROLCDU_Comment[0] ;
            Z124U_Comment2 = T00033_A124U_Comment2[0] ;
            Z125UVID_CONTROLCDU_Estado = T00033_A125UVID_CONTROLCDU_Estado[0] ;
         }
         else
         {
   ...
   public void load038( )
   {
      ...
      {
         RcdFound8 = (short)(1) ;
         A106VisOrder = T00034_A106VisOrder[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A106VisOrder", GXutil.ltrim( GXutil.str( A106VisOrder, 9, 0)));
         A107UVID_CONTROLCDObject = T00034_A107UVID_CONTROLCDObject[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A107UVID_CONTROLCDObject", A107UVID_CONTROLCDObject);
         A108UVID_CONTROLCDLogInst = T00034_A108UVID_CONTROLCDLogInst[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A108UVID_CONTROLCDLogInst", GXutil.ltrim( GXutil.str( A108UVID_CONTROLCDLogInst, 9, 0)));
         A109U_CodAtr = T00034_A109U_CodAtr[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A109U_CodAtr", A109U_CodAtr);
         A110U_NameAtr = T00034_A110U_NameAtr[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A110U_NameAtr", A110U_NameAtr);
         A111U_Cualitat = T00034_A111U_Cualitat[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A111U_Cualitat", A111U_Cualitat);
         A112U_Critico = T00034_A112U_Critico[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A112U_Critico", A112U_Critico);
         A113U_TipoMues = T00034_A113U_TipoMues[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A113U_TipoMues", A113U_TipoMues);
         A114U_Rango = T00034_A114U_Rango[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A114U_Rango", A114U_Rango);
         A115U_TipoDef = T00034_A115U_TipoDef[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A115U_TipoDef", A115U_TipoDef);
         A116U_AQL = T00034_A116U_AQL[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A116U_AQL", A116U_AQL);
         A117U_TiempoDu = T00034_A117U_TiempoDu[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A117U_TiempoDu", GXutil.ltrim( GXutil.str( A117U_TiempoDu, 18, 0)));
         A118U_StandAtr = T00034_A118U_StandAtr[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A118U_StandAtr", GXutil.ltrim( GXutil.str( A118U_StandAtr, 18, 0)));
         A119U_Minimo = T00034_A119U_Minimo[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A119U_Minimo", GXutil.ltrim( GXutil.str( A119U_Minimo, 18, 0)));
         A120U_Maximo = T00034_A120U_Maximo[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A120U_Maximo", GXutil.ltrim( GXutil.str( A120U_Maximo, 18, 0)));
         A121U_Medicion = T00034_A121U_Medicion[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A121U_Medicion", GXutil.ltrim( GXutil.str( A121U_Medicion, 18, 0)));
         A122U_CodEquip = T00034_A122U_CodEquip[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A122U_CodEquip", A122U_CodEquip);
         A123UVID_CONTROLCDU_Comment = T00034_A123UVID_CONTROLCDU_Comment[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A123UVID_CONTROLCDU_Comment", A123UVID_CONTROLCDU_Comment);
         A124U_Comment2 = T00034_A124U_Comment2[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A124U_Comment2", A124U_Comment2);
         A125UVID_CONTROLCDU_Estado = T00034_A125UVID_CONTROLCDU_Estado[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A125UVID_CONTROLCDU_Estado", A125UVID_CONTROLCDU_Estado);
         zm038( -1) ;
      }
   ...
   public void getByPrimaryKey( )
   {
      ...
      if ( (pr_fusquim_sap.getStatus(1) != 101) )
      {
         zm038( 1) ;
         RcdFound8 = (short)(1) ;
         A41UVID_CONTROLCDDocEntry = T00033_A41UVID_CONTROLCDDocEntry[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A41UVID_CONTROLCDDocEntry", GXutil.ltrim( GXutil.str( A41UVID_CONTROLCDDocEntry, 9, 0)));
         A42LineId = T00033_A42LineId[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A42LineId", GXutil.ltrim( GXutil.str( A42LineId, 9, 0)));
         A106VisOrder = T00033_A106VisOrder[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A106VisOrder", GXutil.ltrim( GXutil.str( A106VisOrder, 9, 0)));
         A107UVID_CONTROLCDObject = T00033_A107UVID_CONTROLCDObject[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A107UVID_CONTROLCDObject", A107UVID_CONTROLCDObject);
         A108UVID_CONTROLCDLogInst = T00033_A108UVID_CONTROLCDLogInst[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A108UVID_CONTROLCDLogInst", GXutil.ltrim( GXutil.str( A108UVID_CONTROLCDLogInst, 9, 0)));
         A109U_CodAtr = T00033_A109U_CodAtr[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A109U_CodAtr", A109U_CodAtr);
         A110U_NameAtr = T00033_A110U_NameAtr[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A110U_NameAtr", A110U_NameAtr);
         A111U_Cualitat = T00033_A111U_Cualitat[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A111U_Cualitat", A111U_Cualitat);
         A112U_Critico = T00033_A112U_Critico[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A112U_Critico", A112U_Critico);
         A113U_TipoMues = T00033_A113U_TipoMues[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A113U_TipoMues", A113U_TipoMues);
         A114U_Rango = T00033_A114U_Rango[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A114U_Rango", A114U_Rango);
         A115U_TipoDef = T00033_A115U_TipoDef[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A115U_TipoDef", A115U_TipoDef);
         A116U_AQL = T00033_A116U_AQL[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A116U_AQL", A116U_AQL);
         A117U_TiempoDu = T00033_A117U_TiempoDu[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A117U_TiempoDu", GXutil.ltrim( GXutil.str( A117U_TiempoDu, 18, 0)));
         A118U_StandAtr = T00033_A118U_StandAtr[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A118U_StandAtr", GXutil.ltrim( GXutil.str( A118U_StandAtr, 18, 0)));
         A119U_Minimo = T00033_A119U_Minimo[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A119U_Minimo", GXutil.ltrim( GXutil.str( A119U_Minimo, 18, 0)));
         A120U_Maximo = T00033_A120U_Maximo[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A120U_Maximo", GXutil.ltrim( GXutil.str( A120U_Maximo, 18, 0)));
         A121U_Medicion = T00033_A121U_Medicion[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A121U_Medicion", GXutil.ltrim( GXutil.str( A121U_Medicion, 18, 0)));
         A122U_CodEquip = T00033_A122U_CodEquip[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A122U_CodEquip", A122U_CodEquip);
         A123UVID_CONTROLCDU_Comment = T00033_A123UVID_CONTROLCDU_Comment[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A123UVID_CONTROLCDU_Comment", A123UVID_CONTROLCDU_Comment);
         A124U_Comment2 = T00033_A124U_Comment2[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A124U_Comment2", A124U_Comment2);
         A125UVID_CONTROLCDU_Estado = T00033_A125UVID_CONTROLCDU_Estado[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A125UVID_CONTROLCDU_Estado", A125UVID_CONTROLCDU_Estado);
         Z41UVID_CONTROLCDDocEntry = A41UVID_CONTROLCDDocEntry ;
         Z42LineId = A42LineId ;
         sMode8 = Gx_mode ;
   ...
   public void move_next( )
   {
      ...
      {
         while ( (pr_fusquim_sap.getStatus(4) != 101) && ( ( T00036_A41UVID_CONTROLCDDocEntry[0] < A41UVID_CONTROLCDDocEntry ) || ( T00036_A41UVID_CONTROLCDDocEntry[0] == A41UVID_CONTROLCDDocEntry ) && ( T00036_A42LineId[0] < A42LineId ) ) )
         {
            pr_fusquim_sap.readNext(4);
         }
         if ( (pr_fusquim_sap.getStatus(4) != 101) && ( ( T00036_A41UVID_CONTROLCDDocEntry[0] > A41UVID_CONTROLCDDocEntry ) || ( T00036_A41UVID_CONTROLCDDocEntry[0] == A41UVID_CONTROLCDDocEntry ) && ( T00036_A42LineId[0] > A42LineId ) ) )
         {
            A41UVID_CONTROLCDDocEntry = T00036_A41UVID_CONTROLCDDocEntry[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A41UVID_CONTROLCDDocEntry", GXutil.ltrim( GXutil.str( A41UVID_CONTROLCDDocEntry, 9, 0)));
            A42LineId = T00036_A42LineId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A42LineId", GXutil.ltrim( GXutil.str( A42LineId, 9, 0)));
            RcdFound8 = (short)(1) ;
         }
      }
   ...
   public void move_previous( )
   {
      ...
      {
         while ( (pr_fusquim_sap.getStatus(5) != 101) && ( ( T00037_A41UVID_CONTROLCDDocEntry[0] > A41UVID_CONTROLCDDocEntry ) || ( T00037_A41UVID_CONTROLCDDocEntry[0] == A41UVID_CONTROLCDDocEntry ) && ( T00037_A42LineId[0] > A42LineId ) ) )
         {
            pr_fusquim_sap.readNext(5);
         }
         if ( (pr_fusquim_sap.getStatus(5) != 101) && ( ( T00037_A41UVID_CONTROLCDDocEntry[0] < A41UVID_CONTROLCDDocEntry ) || ( T00037_A41UVID_CONTROLCDDocEntry[0] == A41UVID_CONTROLCDDocEntry ) && ( T00037_A42LineId[0] < A42LineId ) ) )
         {
            A41UVID_CONTROLCDDocEntry = T00037_A41UVID_CONTROLCDDocEntry[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A41UVID_CONTROLCDDocEntry", GXutil.ltrim( GXutil.str( A41UVID_CONTROLCDDocEntry, 9, 0)));
            A42LineId = T00037_A42LineId[0] ;
            httpContext.ajax_rsp_assign_attri("", false, "A42LineId", GXutil.ltrim( GXutil.str( A42LineId, 9, 0)));
            RcdFound8 = (short)(1) ;
         }
      }
   ...
   public void checkOptimisticConcurrency038( )
   {
      if ( GXutil.strcmp(Gx_mode, "INS") != 0 )
      {
         ...
         Gx_longc = false ;
         if ( (pr_fusquim_sap.getStatus(0) == 101) || ( Z106VisOrder != T00032_A106VisOrder[0] ) || ( GXutil.strcmp(Z107UVID_CONTROLCDObject, T00032_A107UVID_CONTROLCDObject[0]) != 0 ) || ( Z108UVID_CONTROLCDLogInst != T00032_A108UVID_CONTROLCDLogInst[0] ) || ( GXutil.strcmp(Z109U_CodAtr, T00032_A109U_CodAtr[0]) != 0 ) || ( GXutil.strcmp(Z110U_NameAtr, T00032_A110U_NameAtr[0]) != 0 ) )
         {
            Gx_longc = true ;
         }
         if ( Gx_longc || ( GXutil.strcmp(Z111U_Cualitat, T00032_A111U_Cualitat[0]) != 0 ) || ( GXutil.strcmp(Z112U_Critico, T00032_A112U_Critico[0]) != 0 ) || ( GXutil.strcmp(Z113U_TipoMues, T00032_A113U_TipoMues[0]) != 0 ) || ( GXutil.strcmp(Z114U_Rango, T00032_A114U_Rango[0]) != 0 ) || ( GXutil.strcmp(Z115U_TipoDef, T00032_A115U_TipoDef[0]) != 0 ) )
         {
            Gx_longc = true ;
         }
         if ( Gx_longc || ( GXutil.strcmp(Z116U_AQL, T00032_A116U_AQL[0]) != 0 ) || ( Z117U_TiempoDu != T00032_A117U_TiempoDu[0] ) || ( Z118U_StandAtr != T00032_A118U_StandAtr[0] ) || ( Z119U_Minimo != T00032_A119U_Minimo[0] ) || ( Z120U_Maximo != T00032_A120U_Maximo[0] ) )
         {
            Gx_longc = true ;
         }
         if ( Gx_longc || ( Z121U_Medicion != T00032_A121U_Medicion[0] ) || ( GXutil.strcmp(Z122U_CodEquip, T00032_A122U_CodEquip[0]) != 0 ) || ( GXutil.strcmp(Z123UVID_CONTROLCDU_Comment, T00032_A123UVID_CONTROLCDU_Comment[0]) != 0 ) || ( GXutil.strcmp(Z124U_Comment2, T00032_A124U_Comment2[0]) != 0 ) || ( GXutil.strcmp(Z125UVID_CONTROLCDU_Estado, T00032_A125UVID_CONTROLCDU_Estado[0]) != 0 ) )
         {
   ...
   public void endLevel038( )
   {
      ...
      if ( AnyError == 0 )
      {
         Application.commit(context, remoteHandle, "FUSQUIM_SAP",pr_fusquim_sap, "uvid_controlcd");
         Application.commit(context, remoteHandle, "DEFAULT",pr_default, "uvid_controlcd");
         if ( AnyError == 0 )
         {
            confirmValues030( ) ;
         }
      ...
      {
         Application.rollback(context, remoteHandle, "FUSQUIM_SAP",pr_fusquim_sap, "uvid_controlcd");
         Application.rollback(context, remoteHandle, "DEFAULT",pr_default, "uvid_controlcd");
      }
      IsModified = (short)(0) ;
      if ( AnyError != 0 )
      {
   ...
   public void scanStart038( )
   {
      ...
      {
         RcdFound8 = (short)(1) ;
         A41UVID_CONTROLCDDocEntry = T000311_A41UVID_CONTROLCDDocEntry[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A41UVID_CONTROLCDDocEntry", GXutil.ltrim( GXutil.str( A41UVID_CONTROLCDDocEntry, 9, 0)));
         A42LineId = T000311_A42LineId[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A42LineId", GXutil.ltrim( GXutil.str( A42LineId, 9, 0)));
      }
      /* Load Subordinate Levels */
   }

   public void scanNext038( )
   {
      /* Scan next routine */
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201811210225544");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.wms.uvid_controlcd") +"\">") ;
   ...
   {
      return formatLink("com.wms.uvid_controlcd")  ;
   }
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201811210225568");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("uvid_controlcd.js", "?201811210225568");
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "UVID_CONTROLCD" );
      bttBtn_delete_Enabled = 1 ;
   ...
   public void initialize( )
   {
      ...
      EvtRowId = "" ;
      sEvtType = "" ;
      T00034_A41UVID_CONTROLCDDocEntry = new int[1] ;
      T00034_A42LineId = new int[1] ;
      T00034_A106VisOrder = new int[1] ;
      T00034_A107UVID_CONTROLCDObject = new String[] {""} ;
      T00034_A108UVID_CONTROLCDLogInst = new int[1] ;
      T00034_A109U_CodAtr = new String[] {""} ;
      T00034_A110U_NameAtr = new String[] {""} ;
      T00034_A111U_Cualitat = new String[] {""} ;
      T00034_A112U_Critico = new String[] {""} ;
      T00034_A113U_TipoMues = new String[] {""} ;
      T00034_A114U_Rango = new String[] {""} ;
      T00034_A115U_TipoDef = new String[] {""} ;
      T00034_A116U_AQL = new String[] {""} ;
      T00034_A117U_TiempoDu = new long[1] ;
      T00034_A118U_StandAtr = new long[1] ;
      T00034_A119U_Minimo = new long[1] ;
      T00034_A120U_Maximo = new long[1] ;
      T00034_A121U_Medicion = new long[1] ;
      T00034_A122U_CodEquip = new String[] {""} ;
      T00034_A123UVID_CONTROLCDU_Comment = new String[] {""} ;
      T00034_A124U_Comment2 = new String[] {""} ;
      T00034_A125UVID_CONTROLCDU_Estado = new String[] {""} ;
      T00035_A41UVID_CONTROLCDDocEntry = new int[1] ;
      T00035_A42LineId = new int[1] ;
      T00033_A41UVID_CONTROLCDDocEntry = new int[1] ;
      T00033_A42LineId = new int[1] ;
      T00033_A106VisOrder = new int[1] ;
      T00033_A107UVID_CONTROLCDObject = new String[] {""} ;
      T00033_A108UVID_CONTROLCDLogInst = new int[1] ;
      T00033_A109U_CodAtr = new String[] {""} ;
      T00033_A110U_NameAtr = new String[] {""} ;
      T00033_A111U_Cualitat = new String[] {""} ;
      T00033_A112U_Critico = new String[] {""} ;
      T00033_A113U_TipoMues = new String[] {""} ;
      T00033_A114U_Rango = new String[] {""} ;
      T00033_A115U_TipoDef = new String[] {""} ;
      T00033_A116U_AQL = new String[] {""} ;
      T00033_A117U_TiempoDu = new long[1] ;
      T00033_A118U_StandAtr = new long[1] ;
      T00033_A119U_Minimo = new long[1] ;
      T00033_A120U_Maximo = new long[1] ;
      T00033_A121U_Medicion = new long[1] ;
      T00033_A122U_CodEquip = new String[] {""} ;
      T00033_A123UVID_CONTROLCDU_Comment = new String[] {""} ;
      T00033_A124U_Comment2 = new String[] {""} ;
      T00033_A125UVID_CONTROLCDU_Estado = new String[] {""} ;
      sMode8 = "" ;
      T00036_A41UVID_CONTROLCDDocEntry = new int[1] ;
      T00036_A42LineId = new int[1] ;
      T00037_A41UVID_CONTROLCDDocEntry = new int[1] ;
      T00037_A42LineId = new int[1] ;
      T00032_A41UVID_CONTROLCDDocEntry = new int[1] ;
      T00032_A42LineId = new int[1] ;
      T00032_A106VisOrder = new int[1] ;
      T00032_A107UVID_CONTROLCDObject = new String[] {""} ;
      T00032_A108UVID_CONTROLCDLogInst = new int[1] ;
      T00032_A109U_CodAtr = new String[] {""} ;
      T00032_A110U_NameAtr = new String[] {""} ;
      T00032_A111U_Cualitat = new String[] {""} ;
      T00032_A112U_Critico = new String[] {""} ;
      T00032_A113U_TipoMues = new String[] {""} ;
      T00032_A114U_Rango = new String[] {""} ;
      T00032_A115U_TipoDef = new String[] {""} ;
      T00032_A116U_AQL = new String[] {""} ;
      T00032_A117U_TiempoDu = new long[1] ;
      T00032_A118U_StandAtr = new long[1] ;
      T00032_A119U_Minimo = new long[1] ;
      T00032_A120U_Maximo = new long[1] ;
      T00032_A121U_Medicion = new long[1] ;
      T00032_A122U_CodEquip = new String[] {""} ;
      T00032_A123UVID_CONTROLCDU_Comment = new String[] {""} ;
      T00032_A124U_Comment2 = new String[] {""} ;
      T00032_A125UVID_CONTROLCDU_Estado = new String[] {""} ;
      T000311_A41UVID_CONTROLCDDocEntry = new int[1] ;
      T000311_A42LineId = new int[1] ;
      sDynURL = "" ;
      FormProcess = "" ;
      bodyStyle = "" ;
      isValidOutput = new com.genexus.GxUnknownObjectCollection();
      pr_fusquim_sap = new DataStoreProvider(context, remoteHandle, new com.wms.uvid_controlcd__fusquim_sap(),
         new Object[] {
             new Object[] {
            T00032_A41UVID_CONTROLCDDocEntry, T00032_A42LineId, T00032_A106VisOrder, T00032_A107UVID_CONTROLCDObject, T00032_A108UVID_CONTROLCDLogInst, T00032_A109U_CodAtr, T00032_A110U_NameAtr, T00032_A111U_Cualitat, T00032_A112U_Critico, T00032_A113U_TipoMues,
            T00032_A114U_Rango, T00032_A115U_TipoDef, T00032_A116U_AQL, T00032_A117U_TiempoDu, T00032_A118U_StandAtr, T00032_A119U_Minimo, T00032_A120U_Maximo, T00032_A121U_Medicion, T00032_A122U_CodEquip, T00032_A123UVID_CONTROLCDU_Comment,
            T00032_A124U_Comment2, T00032_A125UVID_CONTROLCDU_Estado
            }
            , new Object[] {
            T00033_A41UVID_CONTROLCDDocEntry, T00033_A42LineId, T00033_A106VisOrder, T00033_A107UVID_CONTROLCDObject, T00033_A108UVID_CONTROLCDLogInst, T00033_A109U_CodAtr, T00033_A110U_NameAtr, T00033_A111U_Cualitat, T00033_A112U_Critico, T00033_A113U_TipoMues,
            T00033_A114U_Rango, T00033_A115U_TipoDef, T00033_A116U_AQL, T00033_A117U_TiempoDu, T00033_A118U_StandAtr, T00033_A119U_Minimo, T00033_A120U_Maximo, T00033_A121U_Medicion, T00033_A122U_CodEquip, T00033_A123UVID_CONTROLCDU_Comment,
            T00033_A124U_Comment2, T00033_A125UVID_CONTROLCDU_Estado
            }
            , new Object[] {
            T00034_A41UVID_CONTROLCDDocEntry, T00034_A42LineId, T00034_A106VisOrder, T00034_A107UVID_CONTROLCDObject, T00034_A108UVID_CONTROLCDLogInst, T00034_A109U_CodAtr, T00034_A110U_NameAtr, T00034_A111U_Cualitat, T00034_A112U_Critico, T00034_A113U_TipoMues,
            T00034_A114U_Rango, T00034_A115U_TipoDef, T00034_A116U_AQL, T00034_A117U_TiempoDu, T00034_A118U_StandAtr, T00034_A119U_Minimo, T00034_A120U_Maximo, T00034_A121U_Medicion, T00034_A122U_CodEquip, T00034_A123UVID_CONTROLCDU_Comment,
            T00034_A124U_Comment2, T00034_A125UVID_CONTROLCDU_Estado
            }
            , new Object[] {
            T00035_A41UVID_CONTROLCDDocEntry, T00035_A42LineId
            }
            , new Object[] {
            T00036_A41UVID_CONTROLCDDocEntry, T00036_A42LineId
            }
            , new Object[] {
            T00037_A41UVID_CONTROLCDDocEntry, T00037_A42LineId
            }
            , new Object[] {
            }
            , new Object[] {
            ...
            , new Object[] {
            T000311_A41UVID_CONTROLCDDocEntry, T000311_A42LineId
            }
         }
      );
      pr_default = new DataStoreProvider(context, remoteHandle, new com.wms.uvid_controlcd__default(),
         new Object[] {
         }
      );
   }
   ...
   private int[] T00034_A41UVID_CONTROLCDDocEntry ;
   private int[] T00034_A42LineId ;
   private int[] T00034_A106VisOrder ;
   private String[] T00034_A107UVID_CONTROLCDObject ;
   private int[] T00034_A108UVID_CONTROLCDLogInst ;
   private String[] T00034_A109U_CodAtr ;
   private String[] T00034_A110U_NameAtr ;
   private String[] T00034_A111U_Cualitat ;
   private String[] T00034_A112U_Critico ;
   private String[] T00034_A113U_TipoMues ;
   private String[] T00034_A114U_Rango ;
   private String[] T00034_A115U_TipoDef ;
   private String[] T00034_A116U_AQL ;
   private long[] T00034_A117U_TiempoDu ;
   private long[] T00034_A118U_StandAtr ;
   private long[] T00034_A119U_Minimo ;
   private long[] T00034_A120U_Maximo ;
   private long[] T00034_A121U_Medicion ;
   private String[] T00034_A122U_CodEquip ;
   private String[] T00034_A123UVID_CONTROLCDU_Comment ;
   private String[] T00034_A124U_Comment2 ;
   private String[] T00034_A125UVID_CONTROLCDU_Estado ;
   private int[] T00035_A41UVID_CONTROLCDDocEntry ;
   private int[] T00035_A42LineId ;
   private int[] T00033_A41UVID_CONTROLCDDocEntry ;
   private int[] T00033_A42LineId ;
   private int[] T00033_A106VisOrder ;
   private String[] T00033_A107UVID_CONTROLCDObject ;
   private int[] T00033_A108UVID_CONTROLCDLogInst ;
   private String[] T00033_A109U_CodAtr ;
   private String[] T00033_A110U_NameAtr ;
   private String[] T00033_A111U_Cualitat ;
   private String[] T00033_A112U_Critico ;
   private String[] T00033_A113U_TipoMues ;
   private String[] T00033_A114U_Rango ;
   private String[] T00033_A115U_TipoDef ;
   private String[] T00033_A116U_AQL ;
   private long[] T00033_A117U_TiempoDu ;
   private long[] T00033_A118U_StandAtr ;
   private long[] T00033_A119U_Minimo ;
   private long[] T00033_A120U_Maximo ;
   private long[] T00033_A121U_Medicion ;
   private String[] T00033_A122U_CodEquip ;
   private String[] T00033_A123UVID_CONTROLCDU_Comment ;
   private String[] T00033_A124U_Comment2 ;
   private String[] T00033_A125UVID_CONTROLCDU_Estado ;
   private int[] T00036_A41UVID_CONTROLCDDocEntry ;
   private int[] T00036_A42LineId ;
   private int[] T00037_A41UVID_CONTROLCDDocEntry ;
   private int[] T00037_A42LineId ;
   private int[] T00032_A41UVID_CONTROLCDDocEntry ;
   private int[] T00032_A42LineId ;
   private int[] T00032_A106VisOrder ;
   private String[] T00032_A107UVID_CONTROLCDObject ;
   private int[] T00032_A108UVID_CONTROLCDLogInst ;
   private String[] T00032_A109U_CodAtr ;
   private String[] T00032_A110U_NameAtr ;
   private String[] T00032_A111U_Cualitat ;
   private String[] T00032_A112U_Critico ;
   private String[] T00032_A113U_TipoMues ;
   private String[] T00032_A114U_Rango ;
   private String[] T00032_A115U_TipoDef ;
   private String[] T00032_A116U_AQL ;
   private long[] T00032_A117U_TiempoDu ;
   private long[] T00032_A118U_StandAtr ;
   private long[] T00032_A119U_Minimo ;
   private long[] T00032_A120U_Maximo ;
   private long[] T00032_A121U_Medicion ;
   private String[] T00032_A122U_CodEquip ;
   private String[] T00032_A123UVID_CONTROLCDU_Comment ;
   private String[] T00032_A124U_Comment2 ;
   private String[] T00032_A125UVID_CONTROLCDU_Estado ;
   private IDataStoreProvider pr_default ;
   private int[] T000311_A41UVID_CONTROLCDDocEntry ;
   private int[] T000311_A42LineId ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class uvid_controlcd__fusquim_sap extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("T00032", "SELECT [DocEntry], [LineId], [VisOrder], [Object], [LogInst], [U_CodAtr], [U_NameAtr], [U_Cualitat], [U_Critico], [U_TipoMues], [U_Rango], [U_TipoDef], [U_AQL], [U_TiempoDu], [U_StandAtr], [U_Minimo], [U_Maximo], [U_Medicion], [U_CodEquip], [U_Comment], [U_Comment2], [U_Estado] FROM dbo.[@VID_CONTROLCD] WITH (UPDLOCK) WHERE [DocEntry] = ? AND [LineId] = ? ",true, GX_NOMASK, false, this,1,0,false )
         ,new ForEachCursor("T00033", "SELECT [DocEntry], [LineId], [VisOrder], [Object], [LogInst], [U_CodAtr], [U_NameAtr], [U_Cualitat], [U_Critico], [U_TipoMues], [U_Rango], [U_TipoDef], [U_AQL], [U_TiempoDu], [U_StandAtr], [U_Minimo], [U_Maximo], [U_Medicion], [U_CodEquip], [U_Comment], [U_Comment2], [U_Estado] FROM dbo.[@VID_CONTROLCD] WITH (NOLOCK) WHERE [DocEntry] = ? AND [LineId] = ? ",true, GX_NOMASK, false, this,1,0,false )
         ,new ForEachCursor("T00034", "SELECT TM1.[DocEntry], TM1.[LineId], TM1.[VisOrder], TM1.[Object], TM1.[LogInst], TM1.[U_CodAtr], TM1.[U_NameAtr], TM1.[U_Cualitat], TM1.[U_Critico], TM1.[U_TipoMues], TM1.[U_Rango], TM1.[U_TipoDef], TM1.[U_AQL], TM1.[U_TiempoDu], TM1.[U_StandAtr], TM1.[U_Minimo], TM1.[U_Maximo], TM1.[U_Medicion], TM1.[U_CodEquip], TM1.[U_Comment], TM1.[U_Comment2], TM1.[U_Estado] FROM dbo.[@VID_CONTROLCD] TM1 WITH (NOLOCK) WHERE TM1.[DocEntry] = ? and TM1.[LineId] = ? ORDER BY TM1.[DocEntry], TM1.[LineId]  OPTION (FAST 100)",true, GX_NOMASK, false, this,100,0,false )
         ,new ForEachCursor("T00035", "SELECT [DocEntry], [LineId] FROM dbo.[@VID_CONTROLCD] WITH (NOLOCK) WHERE [DocEntry] = ? AND [LineId] = ?  OPTION (FAST 1)",true, GX_NOMASK, false, this,1,0,false )
         ,new ForEachCursor("T00036", "SELECT TOP 1 [DocEntry], [LineId] FROM dbo.[@VID_CONTROLCD] WITH (NOLOCK) WHERE ( [DocEntry] > ? or [DocEntry] = ? and [LineId] > ?) ORDER BY [DocEntry], [LineId]  OPTION (FAST 1)",true, GX_NOMASK, false, this,1,0,true )
         ,new ForEachCursor("T00037", "SELECT TOP 1 [DocEntry], [LineId] FROM dbo.[@VID_CONTROLCD] WITH (NOLOCK) WHERE ( [DocEntry] < ? or [DocEntry] = ? and [LineId] < ?) ORDER BY [DocEntry] DESC, [LineId] DESC  OPTION (FAST 1)",true, GX_NOMASK, false, this,1,0,true )
         ,new UpdateCursor("T00038", "INSERT INTO dbo.[@VID_CONTROLCD]([DocEntry], [LineId], [VisOrder], [Object], [LogInst], [U_CodAtr], [U_NameAtr], [U_Cualitat], [U_Critico], [U_TipoMues], [U_Rango], [U_TipoDef], [U_AQL], [U_TiempoDu], [U_StandAtr], [U_Minimo], [U_Maximo], [U_Medicion], [U_CodEquip], [U_Comment], [U_Comment2], [U_Estado]) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", GX_NOMASK)
         ,new UpdateCursor("T00039", "UPDATE dbo.[@VID_CONTROLCD] SET [VisOrder]=?, [Object]=?, [LogInst]=?, [U_CodAtr]=?, [U_NameAtr]=?, [U_Cualitat]=?, [U_Critico]=?, [U_TipoMues]=?, [U_Rango]=?, [U_TipoDef]=?, [U_AQL]=?, [U_TiempoDu]=?, [U_StandAtr]=?, [U_Minimo]=?, [U_Maximo]=?, [U_Medicion]=?, [U_CodEquip]=?, [U_Comment]=?, [U_Comment2]=?, [U_Estado]=?  WHERE [DocEntry] = ? AND [LineId] = ?", GX_NOMASK)
         ,new UpdateCursor("T000310", "DELETE FROM dbo.[@VID_CONTROLCD]  WHERE [DocEntry] = ? AND [LineId] = ?", GX_NOMASK)
         ,new ForEachCursor("T000311", "SELECT [DocEntry], [LineId] FROM dbo.[@VID_CONTROLCD] WITH (NOLOCK) ORDER BY [DocEntry], [LineId]  OPTION (FAST 100)",true, GX_NOMASK, false, this,100,0,false )
      };
   }
...
final  class uvid_controlcd__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
