...
public final  class gx0050_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201811210232794");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.wms.gx0050") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13pUVID_CONTROLCHDocEntry,9,0)))+"\">") ;
   ...
   {
      return formatLink("com.wms.gx0050") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV13pUVID_CONTROLCHDocEntry,9,0))) ;
   }
   ...
   public void wb0X0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblLbluvid_controlchdocentryfilter_Internalname, "UVID_CONTROLCHDoc Entry", "", "", lblLbluvid_controlchdocentryfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0050.htm");
         ...
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblLbldocnumfilter_Internalname, "Doc Num", "", "", lblLbldocnumfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0050.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.wms.GxWebStd.gx_single_line_edit( httpContext, edtavCdocnum_Internalname, GXutil.ltrim( localUtil.ntoc( AV7cDocNum, (byte)(9), (byte)(0), ",", "")), ((edtavCdocnum_Enabled!=0) ? GXutil.ltrim( localUtil.format( DecimalUtil.doubleToDec(AV7cDocNum), "ZZZZZZZZ9")) : localUtil.format( DecimalUtil.doubleToDec(AV7cDocNum), "ZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCdocnum_Jsonclick, 0, "Attribute", "", "", "", edtavCdocnum_Visible, edtavCdocnum_Enabled, 0, "text", "", 9, "chr", 1, "row", 9, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(0), true, "", "right", "HLP_Gx0050.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblLblperiodfilter_Internalname, "Period", "", "", lblLblperiodfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e130x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0050.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblLblinstancefilter_Internalname, "Instance", "", "", lblLblinstancefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e140x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0050.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblLblseriesfilter_Internalname, "Series", "", "", lblLblseriesfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e150x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0050.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblLblhandwrttenfilter_Internalname, "Handwrtten", "", "", lblLblhandwrttenfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e160x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0050.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         com.wms.GxWebStd.gx_single_line_edit( httpContext, edtavChandwrtten_Internalname, GXutil.rtrim( AV11cHandwrtten), GXutil.rtrim( localUtil.format( AV11cHandwrtten, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavChandwrtten_Jsonclick, 0, "Attribute", "", "", "", edtavChandwrtten_Visible, edtavChandwrtten_Enabled, 0, "text", "", 1, "chr", 1, "row", 1, (byte)(0), (short)(0), 0, (byte)(1), (byte)(-1), (byte)(-1), true, "", "left", "HLP_Gx0050.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         ...
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblLblcanceledfilter_Internalname, "Canceled", "", "", lblLblcanceledfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e170x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, (short)(1), "HLP_Gx0050.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         StyleString = "" ;
         com.wms.GxWebStd.gx_button_ctrl( httpContext, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+GXutil.str( 84, 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e180x1_client"+"'", TempTags, "", 2, "HLP_Gx0050.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         /* Div Control */
         com.wms.GxWebStd.gx_div_start( httpContext, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      if ( wbEnd == 84 )
      {
         ...
         StyleString = "" ;
         com.wms.GxWebStd.gx_button_ctrl( httpContext, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+GXutil.str( 84, 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", httpContext.getButtonType( ), "HLP_Gx0050.htm");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
         com.wms.GxWebStd.gx_div_end( httpContext, "left", "top", "div");
   ...
   public void rf0X2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         /* Using cursor H000X2 */
         pr_fusquim_sap.execute(0, new Object[] {new Integer(AV6cUVID_CONTROLCHDocEntry), new Integer(AV7cDocNum), new Integer(AV8cPeriod), new Short(AV9cInstance), new Integer(AV10cSeries), lV11cHandwrtten, lV12cCanceled, new Integer(GXPagingFrom2), new Integer(GXPagingTo2), new Integer(GXPagingTo2)});
         nGXsfl_84_idx = (short)(1) ;
         sGXsfl_84_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_84_idx, 4, 0)), (short)(4), "0") ;
         subsflControlProps_842( ) ;
         while ( ( (pr_fusquim_sap.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subgrid1_recordsperpage( ) ) ) ) )
         {
            A54Status = H000X2_A54Status[0] ;
            n54Status = H000X2_n54Status[0] ;
            A51UVID_CONTROLCHLogInst = H000X2_A51UVID_CONTROLCHLogInst[0] ;
            n51UVID_CONTROLCHLogInst = H000X2_n51UVID_CONTROLCHLogInst[0] ;
            A50UVID_CONTROLCHObject = H000X2_A50UVID_CONTROLCHObject[0] ;
            n50UVID_CONTROLCHObject = H000X2_n50UVID_CONTROLCHObject[0] ;
            A49Canceled = H000X2_A49Canceled[0] ;
            n49Canceled = H000X2_n49Canceled[0] ;
            A48Handwrtten = H000X2_A48Handwrtten[0] ;
            n48Handwrtten = H000X2_n48Handwrtten[0] ;
            A47Series = H000X2_A47Series[0] ;
            n47Series = H000X2_n47Series[0] ;
            A46Instance = H000X2_A46Instance[0] ;
            n46Instance = H000X2_n46Instance[0] ;
            A45Period = H000X2_A45Period[0] ;
            n45Period = H000X2_n45Period[0] ;
            A44DocNum = H000X2_A44DocNum[0] ;
            n44DocNum = H000X2_n44DocNum[0] ;
            A43UVID_CONTROLCHDocEntry = H000X2_A43UVID_CONTROLCHDocEntry[0] ;
            /* Execute user event: Load */
            e200X2 ();
   ...
   public int subgrid1_recordcount( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV12cCanceled", AV12cCanceled);
      /* Using cursor H000X3 */
      pr_fusquim_sap.execute(1, new Object[] {new Integer(AV6cUVID_CONTROLCHDocEntry), new Integer(AV7cDocNum), new Integer(AV8cPeriod), new Short(AV9cInstance), new Integer(AV10cSeries), lV11cHandwrtten, lV12cCanceled});
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201811210233033");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("gx0050.js", "?201811210233033");
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("LBLUVID_CONTROLCHDOCENTRYFILTER.CLICK","{handler:'e110X1',iparms:[{av:'divUvid_controlchdocentryfiltercontainer_Class',ctrl:'UVID_CONTROLCHDOCENTRYFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divUvid_controlchdocentryfiltercontainer_Class',ctrl:'UVID_CONTROLCHDOCENTRYFILTERCONTAINER',prop:'Class'},{av:'edtavCuvid_controlchdocentry_Visible',ctrl:'vCUVID_CONTROLCHDOCENTRY',prop:'Visible'}]}");
      setEventMetadata("LBLDOCNUMFILTER.CLICK","{handler:'e120X1',iparms:[{av:'divDocnumfiltercontainer_Class',ctrl:'DOCNUMFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divDocnumfiltercontainer_Class',ctrl:'DOCNUMFILTERCONTAINER',prop:'Class'},{av:'edtavCdocnum_Visible',ctrl:'vCDOCNUM',prop:'Visible'}]}");
      setEventMetadata("LBLPERIODFILTER.CLICK","{handler:'e130X1',iparms:[{av:'divPeriodfiltercontainer_Class',ctrl:'PERIODFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divPeriodfiltercontainer_Class',ctrl:'PERIODFILTERCONTAINER',prop:'Class'},{av:'edtavCperiod_Visible',ctrl:'vCPERIOD',prop:'Visible'}]}");
      setEventMetadata("LBLINSTANCEFILTER.CLICK","{handler:'e140X1',iparms:[{av:'divInstancefiltercontainer_Class',ctrl:'INSTANCEFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divInstancefiltercontainer_Class',ctrl:'INSTANCEFILTERCONTAINER',prop:'Class'},{av:'edtavCinstance_Visible',ctrl:'vCINSTANCE',prop:'Visible'}]}");
      setEventMetadata("LBLSERIESFILTER.CLICK","{handler:'e150X1',iparms:[{av:'divSeriesfiltercontainer_Class',ctrl:'SERIESFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divSeriesfiltercontainer_Class',ctrl:'SERIESFILTERCONTAINER',prop:'Class'},{av:'edtavCseries_Visible',ctrl:'vCSERIES',prop:'Visible'}]}");
      setEventMetadata("LBLHANDWRTTENFILTER.CLICK","{handler:'e160X1',iparms:[{av:'divHandwrttenfiltercontainer_Class',ctrl:'HANDWRTTENFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divHandwrttenfiltercontainer_Class',ctrl:'HANDWRTTENFILTERCONTAINER',prop:'Class'},{av:'edtavChandwrtten_Visible',ctrl:'vCHANDWRTTEN',prop:'Visible'}]}");
      setEventMetadata("LBLCANCELEDFILTER.CLICK","{handler:'e170X1',iparms:[{av:'divCanceledfiltercontainer_Class',ctrl:'CANCELEDFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divCanceledfiltercontainer_Class',ctrl:'CANCELEDFILTERCONTAINER',prop:'Class'},{av:'edtavCcanceled_Visible',ctrl:'vCCANCELED',prop:'Visible'}]}");
      setEventMetadata("ENTER","{handler:'e210X2',iparms:[{av:'A43UVID_CONTROLCHDocEntry',fld:'UVID_CONTROLCHDOCENTRY',pic:'ZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'AV13pUVID_CONTROLCHDocEntry',fld:'vPUVID_CONTROLCHDOCENTRY',pic:'ZZZZZZZZ9',nv:0}]}");
   ...
   public void initialize( )
   {
      ...
      lV11cHandwrtten = "" ;
      lV12cCanceled = "" ;
      H000X2_A54Status = new String[] {""} ;
      H000X2_n54Status = new boolean[] {false} ;
      H000X2_A51UVID_CONTROLCHLogInst = new int[1] ;
      H000X2_n51UVID_CONTROLCHLogInst = new boolean[] {false} ;
      H000X2_A50UVID_CONTROLCHObject = new String[] {""} ;
      H000X2_n50UVID_CONTROLCHObject = new boolean[] {false} ;
      H000X2_A49Canceled = new String[] {""} ;
      H000X2_n49Canceled = new boolean[] {false} ;
      H000X2_A48Handwrtten = new String[] {""} ;
      H000X2_n48Handwrtten = new boolean[] {false} ;
      H000X2_A47Series = new int[1] ;
      H000X2_n47Series = new boolean[] {false} ;
      H000X2_A46Instance = new short[1] ;
      H000X2_n46Instance = new boolean[] {false} ;
      H000X2_A45Period = new int[1] ;
      H000X2_n45Period = new boolean[] {false} ;
      H000X2_A44DocNum = new int[1] ;
      H000X2_n44DocNum = new boolean[] {false} ;
      H000X2_A43UVID_CONTROLCHDocEntry = new int[1] ;
      H000X3_AGRID1_nRecordCount = new long[1] ;
      AV14ADVANCED_LABEL_TEMPLATE = "" ;
      Grid1Row = new com.genexus.webpanels.GXWebRow();
      sImgUrl = "" ;
      ROClassString = "" ;
      pr_fusquim_sap = new DataStoreProvider(context, remoteHandle, new com.wms.gx0050__fusquim_sap(),
         new Object[] {
             new Object[] {
            H000X2_A54Status, H000X2_n54Status, H000X2_A51UVID_CONTROLCHLogInst, H000X2_n51UVID_CONTROLCHLogInst, H000X2_A50UVID_CONTROLCHObject, H000X2_n50UVID_CONTROLCHObject, H000X2_A49Canceled, H000X2_n49Canceled, H000X2_A48Handwrtten, H000X2_n48Handwrtten,
            H000X2_A47Series, H000X2_n47Series, H000X2_A46Instance, H000X2_n46Instance, H000X2_A45Period, H000X2_n45Period, H000X2_A44DocNum, H000X2_n44DocNum, H000X2_A43UVID_CONTROLCHDocEntry
            }
            , new Object[] {
   ...
   private String[] H000X2_A54Status ;
   private boolean[] H000X2_n54Status ;
   private int[] H000X2_A51UVID_CONTROLCHLogInst ;
   private boolean[] H000X2_n51UVID_CONTROLCHLogInst ;
   private String[] H000X2_A50UVID_CONTROLCHObject ;
   private boolean[] H000X2_n50UVID_CONTROLCHObject ;
   private String[] H000X2_A49Canceled ;
   private boolean[] H000X2_n49Canceled ;
   private String[] H000X2_A48Handwrtten ;
   private boolean[] H000X2_n48Handwrtten ;
   private int[] H000X2_A47Series ;
   private boolean[] H000X2_n47Series ;
   private short[] H000X2_A46Instance ;
   private boolean[] H000X2_n46Instance ;
   private int[] H000X2_A45Period ;
   private boolean[] H000X2_n45Period ;
   private int[] H000X2_A44DocNum ;
   private boolean[] H000X2_n44DocNum ;
   private int[] H000X2_A43UVID_CONTROLCHDocEntry ;
   private long[] H000X3_AGRID1_nRecordCount ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class gx0050__fusquim_sap extends DataStoreHelperBase implements ILocalDataStoreHelper
{
