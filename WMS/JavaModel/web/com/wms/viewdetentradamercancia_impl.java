/*
               File: viewdetentradamercancia_impl
        Description: View Det Entrada Mercancia
             Author: GeneXus Java Generator version 15_0_3-111985
       Generated on: January 12, 2018 10:23:16.66
...
public final  class viewdetentradamercancia_impl extends GXDataArea
{
   public viewdetentradamercancia_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public viewdetentradamercancia_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( viewdetentradamercancia_impl.class ));
   }
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201811210231671");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("com.wms.viewdetentradamercancia") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV12CabEntradaMercanciaId,6,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV6TabCode))+"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      forbiddenHiddens = "hsh" + "ViewDetEntradaMercancia" ;
   ...
   {
      return formatLink("com.wms.viewdetentradamercancia") + "?" + GXutil.URLEncode(GXutil.ltrim(GXutil.str(AV12CabEntradaMercanciaId,6,0))) + "," + GXutil.URLEncode(GXutil.rtrim(AV6TabCode)) ;
   }

   public String getPgmname( )
   {
      return "ViewDetEntradaMercancia" ;
   }

   public String getPgmdesc( )
   {
      return "View Det Entrada Mercancia" ;
   }
   ...
   public void wb0I0( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblViewtitle_Internalname, "Det Entrada Mercancia Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, (short)(0), "HLP_ViewDetEntradaMercancia.htm");
         ...
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblViewall_Internalname, "Det Entrada Mercancias", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, (short)(0), "HLP_ViewDetEntradaMercancia.htm");
         ...
         /* Text block */
         com.wms.GxWebStd.gx_label_ctrl( httpContext, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, (short)(0), "HLP_ViewDetEntradaMercancia.htm");
         /* Div Control */
   ...
   public void start0I2( )
   {
      ...
      if ( ! httpContext.isSpaRequest( ) )
      {
         ...
         Form.getMeta().addItem("description", "View Det Entrada Mercancia", (short)(0)) ;
      }
      httpContext.wjLoc = "" ;
   ...
   {
      /* GeneXus formulas. */
      AV15Pgmname = "ViewDetEntradaMercancia" ;
      Gx_err = (short)(0) ;
   }
   ...
   public void rf0I2( )
   {
      ...
      if ( ! httpContext.willRedirect( ) && ( httpContext.nUserReturn != 1 ) )
      {
         ...
         {
            A24CabEntradaMercanciaId = H000I2_A24CabEntradaMercanciaId[0] ;
            A1OcDocEntry = H000I2_A1OcDocEntry[0] ;
   ...
   public void e110I2( )
   {
      ...
      {
         A24CabEntradaMercanciaId = H000I3_A24CabEntradaMercanciaId[0] ;
         A1OcDocEntry = H000I3_A1OcDocEntry[0] ;
         httpContext.ajax_rsp_assign_attri("", false, "A1OcDocEntry", GXutil.ltrim( GXutil.str( A1OcDocEntry, 9, 0)));
         httpContext.ajax_rsp_assign_attri("", false, "gxhash_OCDOCENTRY", getSecureSignedToken( "", localUtil.format( DecimalUtil.doubleToDec(A1OcDocEntry), "ZZZZZZZZ9")));
         AV16GXLvl6 = (byte)(1) ;
         Form.setCaption( GXutil.str( A1OcDocEntry, 9, 0) );
         httpContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.getCaption(), true);
         lblViewall_Link = formatLink("com.wms.wwdetentradamercancia")  ;
   ...
   public void S112( )
   {
      ...
      {
         /* Object Property */
         if ( GXutil.strcmp(GXutil.lower( WebComp_Generalwc_Component), GXutil.lower( "DetEntradaMercanciaGeneral")) != 0 )
         {
            WebComp_Generalwc = WebUtils.getWebComponent(getClass(), "com.wms.detentradamercanciageneral_impl", remoteHandle, context);
            WebComp_Generalwc_Component = "DetEntradaMercanciaGeneral" ;
         }
         if ( GXutil.len( WebComp_Generalwc_Component) != 0 )
         {
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201811210231718");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      ...
      httpContext.AddJavascriptSource("viewdetentradamercancia.js", "?201811210231718");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "");
      httpContext.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "");
   ...
   public void initialize_properties( )
   {
      ...
      Form.setCaption( "View Det Entrada Mercancia" );
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableJsOutput();
      }
   ...
   public void initialize( )
   {
      ...
      AV15Pgmname = "" ;
      scmdbuf = "" ;
      H000I2_A24CabEntradaMercanciaId = new int[1] ;
      H000I2_A1OcDocEntry = new int[1] ;
      hsh = "" ;
      H000I3_A24CabEntradaMercanciaId = new int[1] ;
      H000I3_A1OcDocEntry = new int[1] ;
      BackMsgLst = new com.genexus.internet.MsgList();
      LclMsgLst = new com.genexus.internet.MsgList();
      pr_default = new DataStoreProvider(context, remoteHandle, new com.wms.viewdetentradamercancia__default(),
         new Object[] {
             new Object[] {
            H000I2_A24CabEntradaMercanciaId, H000I2_A1OcDocEntry
            }
            , new Object[] {
            H000I3_A24CabEntradaMercanciaId, H000I3_A1OcDocEntry
            }
         }
      );
      AV15Pgmname = "ViewDetEntradaMercancia" ;
   ...
   private int[] H000I2_A24CabEntradaMercanciaId ;
   private int[] H000I2_A1OcDocEntry ;
   private int[] H000I3_A24CabEntradaMercanciaId ;
   private int[] H000I3_A1OcDocEntry ;
   private com.genexus.webpanels.GXWebForm Form ;
}

final  class viewdetentradamercancia__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
          new ForEachCursor("H000I2", "SELECT [CabEntradaMercanciaId], [OcDocEntry] FROM [CabEntradaMercancia] WITH (NOLOCK) WHERE [CabEntradaMercanciaId] = ? ORDER BY [CabEntradaMercanciaId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H000I3", "SELECT [CabEntradaMercanciaId], [OcDocEntry] FROM [CabEntradaMercancia] WITH (NOLOCK) WHERE [CabEntradaMercanciaId] = ? ORDER BY [CabEntradaMercanciaId] ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
      };
   }
