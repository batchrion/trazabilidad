...
public final  class home_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?201811210231561");
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
      ...
      if ( nGXWrapped != 1 )
      {
         httpContext.writeTextNL( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("com.wms.home") +"\">") ;
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      /* Send saved values. */
      com.wms.GxWebStd.gx_hidden_field( httpContext, "nRC_GXsfl_5", GXutil.ltrim( localUtil.ntoc( nRC_GXsfl_5, (byte)(4), (byte)(0), ",", "")));
      GXKey = com.genexus.util.Encryption.decrypt64( httpContext.getCookie( "GX_SESSION_ID"), context.getServerKey( )) ;
   }
   ...
   {
      return formatLink("com.wms.home")  ;
   }
   ...
   private void e11082( )
   {
      ...
      new com.wms.listprograms(remoteHandle, context).execute( GXv_objcol_SdtProgramNames_ProgramName1) ;
      AV6ProgramNames = GXv_objcol_SdtProgramNames_ProgramName1[0] ;
      AV10GXV1 = 1 ;
      while ( AV10GXV1 <= AV6ProgramNames.size() )
      {
         AV7ProgramName = (com.wms.SdtProgramNames_ProgramName)((com.wms.SdtProgramNames_ProgramName)AV6ProgramNames.elementAt(-1+AV10GXV1));
   ...
   public void wb_table1_2_082( boolean wbgen )
   {
      if ( wbgen )
      {
         ...
         if ( Grid1Container.GetWrapped() == 1 )
         {
            ...
            com.wms.GxWebStd.gx_table_start( httpContext, subGrid1_Internalname, subGrid1_Internalname, "", "", 0, "", "", 1, 0, sStyleString, "", 0);
            Grid1Container.AddObjectProperty("GridName", "Grid1");
         }
         else
         {
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?201811210231576");
         idxLst = (int)(idxLst+1) ;
      }
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("home.js", "?201811210231576");
      }
   ...
   public void sendrow_52( )
   {
      ...
      Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {edtavMenuitem_Internalname,GXutil.rtrim( AV5MenuItem),"","","'"+""+"'"+",false,"+"'"+""+"'",edtavMenuitem_Link,"","","",edtavMenuitem_Jsonclick,new Integer(0),"Attribute","",ROClassString,"",new Integer(1),new Integer(0),new Integer(0),"text","",new Integer(80),"chr",new Integer(1),"row",new Integer(100),new Integer(0),new Integer(0),new Integer(5),new Integer(1),new Integer(-1),new Integer(-1),new Boolean(false),"","left"});
      if ( Grid1Container.GetWrapped() == 1 )
      {
   ...
   public void initialize( )
   {
      ...
      AV6ProgramNames = new GXBaseCollection<com.wms.SdtProgramNames_ProgramName>(com.wms.SdtProgramNames_ProgramName.class, "ProgramNames.ProgramName", "WMS", remoteHandle);
      GXv_objcol_SdtProgramNames_ProgramName1 = new GXBaseCollection [1] ;
      AV7ProgramName = new com.wms.SdtProgramNames_ProgramName(remoteHandle, context);
   ...
   private GXBaseCollection<com.wms.SdtProgramNames_ProgramName> AV6ProgramNames ;
   private GXBaseCollection<com.wms.SdtProgramNames_ProgramName> GXv_objcol_SdtProgramNames_ProgramName1[] ;
   private com.wms.SdtProgramNames_ProgramName AV7ProgramName ;
}
